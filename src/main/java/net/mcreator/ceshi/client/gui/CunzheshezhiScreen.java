...
public class CunzheshezhiScreen extends AbstractContainerScreen<CunzheshezhiMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.primogemcraft.cunzheshezhi.label_empty"), 90, 66, -10066330, false);
	...
	public void init() {
		...
		}).bounds(this.leftPos + 21, this.topPos + 35, 35, 20).build();
