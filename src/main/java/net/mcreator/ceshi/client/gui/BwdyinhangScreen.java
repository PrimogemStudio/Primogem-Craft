...
public class BwdyinhangScreen extends AbstractContainerScreen<BwdyinhangMenu> {
	...
	public void init() {
		super.init();
		imagebutton_dui = new ImageButton(this.leftPos + 127, this.topPos + 27, 21, 21, 0, 0, 21, new ResourceLocation("primogemcraft:textures/screens/atlas/imagebutton_dui.png"), 21, 42, e -> {
			if (true) {
				PrimogemcraftMod.PACKET_HANDLER.sendToServer(new BwdyinhangButtonMessage(0, x, y, z));
		...
		imagebutton_cuo = new ImageButton(this.leftPos + 127, this.topPos + 54, 21, 21, 0, 0, 21, new ResourceLocation("primogemcraft:textures/screens/atlas/imagebutton_cuo.png"), 21, 42, e -> {
			if (true) {
				PrimogemcraftMod.PACKET_HANDLER.sendToServer(new BwdyinhangButtonMessage(1, x, y, z));
