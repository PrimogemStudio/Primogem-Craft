...
public class BwdyinhangScreen extends AbstractContainerScreen<BwdyinhangMenu> {
	...
	public void init() {
		super.init();
		button_cun_ru_zhe_xie = Button.builder(Component.translatable("gui.primogemcraft.bwdyinhang.button_cun_ru_zhe_xie"), e -> {
			if (true) {
		...
		button_qing_ni_gun_kai = Button.builder(Component.translatable("gui.primogemcraft.bwdyinhang.button_qing_ni_gun_kai"), e -> {
			if (true) {
