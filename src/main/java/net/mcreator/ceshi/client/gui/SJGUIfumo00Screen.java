...
public class SJGUIfumo00Screen extends AbstractContainerScreen<SJGUIfumo00Menu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.primogemcraft.sjgu_ifumo_00.label_xiao_hao_20dang_qian_zui_da_hp"), 34, 27, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.primogemcraft.sjgu_ifumo_00.label_xiao_hao_70dang_qian_zui_da_hp"), 34, 74, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.primogemcraft.sjgu_ifumo_00.label_xiao_hao_dang_qian_95zui_da_hp"), 35, 122, -1, false);
	}
