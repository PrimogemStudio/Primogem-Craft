	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (EnchantmentHelper.getItemEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get(), a) != 0 && !a.is(ItemTags.create(new ResourceLocation("pgc:token_mending")))) {
				if (a.getDamageValue() >= Math.round(a.getMaxDamage() * 0.01 * a.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(PrimogemcraftModItems.YUZHOUSUIPIAN.get());
						_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
					}
					a.setDamageValue((int) (a.getDamageValue() - Math.round(a.getMaxDamage() * 0.01 * a.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)));
				}
			}
			...
			if (EnchantmentHelper.getItemEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get(), b) != 0 && !b.is(ItemTags.create(new ResourceLocation("pgc:token_mending")))) {
				if (b.getDamageValue() >= Math.round(b.getMaxDamage() * 0.01 * b.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(PrimogemcraftModItems.YUZHOUSUIPIAN.get());
						_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
					}
					b.setDamageValue((int) (b.getDamageValue() - Math.round(b.getMaxDamage() * 0.01 * b.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)));
				}
			}
			...
			if (EnchantmentHelper.getItemEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get(), a0) != 0 && !a0.is(ItemTags.create(new ResourceLocation("pgc:token_mending")))) {
				if (a0.getDamageValue() >= Math.round(a0.getMaxDamage() * 0.01 * a0.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(PrimogemcraftModItems.YUZHOUSUIPIAN.get());
						_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
					}
					a0.setDamageValue((int) (a0.getDamageValue() - Math.round(a0.getMaxDamage() * 0.01 * a0.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)));
				}
			}
			...
			if (EnchantmentHelper.getItemEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get(), a2) != 0 && !a2.is(ItemTags.create(new ResourceLocation("pgc:token_mending")))) {
				if (a2.getDamageValue() >= Math.round(a2.getMaxDamage() * 0.01 * a2.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(PrimogemcraftModItems.YUZHOUSUIPIAN.get());
						_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
					}
					a2.setDamageValue((int) (a2.getDamageValue() - Math.round(a2.getMaxDamage() * 0.01 * a2.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)));
				}
			}
			...
			if (EnchantmentHelper.getItemEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get(), a3) != 0 && !a3.is(ItemTags.create(new ResourceLocation("pgc:token_mending")))) {
				if (a3.getDamageValue() >= Math.round(a3.getMaxDamage() * 0.01 * a3.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)) {
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(PrimogemcraftModItems.YUZHOUSUIPIAN.get());
						_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
					}
					a3.setDamageValue((int) (a3.getDamageValue() - Math.round(a3.getMaxDamage() * 0.01 * a3.getEnchantmentLevel(PrimogemcraftModEnchantments.FMYUZHOUSUIPIAN.get()) * 2)));
				}
			}
		}
	}
