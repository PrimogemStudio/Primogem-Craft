...
public class Daima4shuxingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && !itemstack.getOrCreateTag().getBoolean("daima4_yixiufu") && itemstack.getDamageValue() == 0) {
		...
		if (itemstack.getOrCreateTag().getBoolean("daima4_yixiufu")) {
			if (!(entity instanceof LivingEntity _livEnt18 && _livEnt18.hasEffect(PrimogemcraftModMobEffects.JINGQUEDAIMA.get()))) {
