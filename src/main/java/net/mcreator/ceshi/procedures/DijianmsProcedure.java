	...
	public static String execute(ItemStack itemstack) {
		...
		return MSHSwuqi00Procedure.execute(itemstack,
				"\u00A76\u00A7l\u00A7n\u666E\u901A\u653B\u51FB" + "\n"
						...
						+ new java.text.DecimalFormat("##.##%").format(1 + itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("jing_lian") * 0.25)
						+ "\u00A7e\u7684\u9B54\u6CD5\u4F24\u5BB3\u540E\u6E05\u96F6\uFF0C\u6BCF2.0\u79D2\u81F3\u591A\u83B7\u5F971\u5C42\u97F3\u7B26" + "\n"
						...
						+ "\u00A7e\u6D88\u8017\u5F53\u524D\u6240\u6709\u97F3\u7B26\uFF0C\u6BCF\u5C42\u6062\u590D\u00A7b"
						+ new java.text.DecimalFormat("##.##%").format((1 + itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("jing_lian") * 0.25) * 0.05) + "\u00A7e\u5DF2\u635F\u5931\u7684\u751F\u547D\u503C");
	}
}
