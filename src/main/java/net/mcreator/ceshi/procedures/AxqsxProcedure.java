		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.ICE || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.PACKED_ICE
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.tnt.primed")), SoundSource.BLOCKS, 1, 30);
				} else {
					_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.tnt.primed")), SoundSource.BLOCKS, 1, 30, false);
				}
			}
			{
