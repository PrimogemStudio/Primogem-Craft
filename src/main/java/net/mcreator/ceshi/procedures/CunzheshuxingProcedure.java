...
public class CunzheshuxingProcedure {
	public static void execute(Entity entity, HashMap guistate) {
		...
		if (!((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).getItem() == Blocks.AIR.asItem())) {
			if (guistate.containsKey("checkbox:shifou_bwd") && ((Checkbox) guistate.get("checkbox:shifou_bwd")).selected()) {
			...
			(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("pgc_cunchu",
					((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).getOrCreateTag().getDouble("pgc_cunchu")
			...
			if (Math.round(new Object() {
			...
			}.convert(guistate.containsKey("text:cunzhe_shuliang") ? ((EditBox) guistate.get("text:cunzhe_shuliang")).getValue() : "")) >= 256) {
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal(("\u00A7c\u6CE8\u610F\uFF01\u00A78\u4F60\u521A\u521A\u8BBE\u7F6E\u4E86\u00A7d<" + new java.text.DecimalFormat("##.##").format(Math.round(new Object() {
						double convert(String s) {
							try {
								return Double.parseDouble(s.trim());
							} catch (Exception e) {
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal(("\u00A77\u6DFB\u52A0\u4E86" + new java.text.DecimalFormat("##.##").format(Math.round(new Object() {
						double convert(String s) {
							try {
								return Double.parseDouble(s.trim());
							} catch (Exception e) {
					...
					}.convert(guistate.containsKey("text:cunzhe_shuliang") ? ((EditBox) guistate.get("text:cunzhe_shuliang")).getValue() : ""))))), false);
			}
