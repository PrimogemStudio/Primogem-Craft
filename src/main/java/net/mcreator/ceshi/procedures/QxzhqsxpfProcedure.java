...
public class QxzhqsxpfProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (ModList.get().isLoaded("genshincraft")) {
			QxzhqsxhsProcedure.execute(world, x, y, z, new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("genshincraft:primogems"))), new ItemStack(PrimogemcraftModItems.YUANSHI.get()), 2, 1, 6, 1);
		}
	}
}
