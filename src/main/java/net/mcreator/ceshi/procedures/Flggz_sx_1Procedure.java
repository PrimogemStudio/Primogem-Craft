...
public class Flggz_sx_1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		double jingyan = 0;
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(PrimogemcraftModMobEffects.FZGGZXG_0.get())) {
			...
			if (itemstack.getDamageValue() == 0 && !(entity instanceof LivingEntity _livEnt28 && _livEnt28.hasEffect(PrimogemcraftModMobEffects.FZGGZXG_1.get()))) {
				...
				if (entity instanceof LivingEntity _entity)
					_entity.removeEffect(PrimogemcraftModMobEffects.FZGGZXG_0.get());
				if (entity instanceof LivingEntity _entity)
