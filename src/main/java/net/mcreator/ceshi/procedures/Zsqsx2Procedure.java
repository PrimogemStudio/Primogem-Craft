		...
		if (entity.isShiftKeyDown()) {
			...
			if (itemstack.getOrCreateTag().getBoolean("zsq_sx_0")) {
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal(("\u00A7c\u6548\u679C\u5EF6\u8FDF" + itemstack.getOrCreateTag().getDouble("zsq_sx") + "\u79D2\uFF01")), true);
			} else {
				itemstack.getOrCreateTag().putDouble("zsq_sx", (itemstack.getOrCreateTag().getDouble("zsq_sx") + 10));
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal(("\u00A7a\u6548\u679C\u5EF6\u8FDF" + itemstack.getOrCreateTag().getDouble("zsq_sx") + "\u79D2\uFF01")), true);
			}
