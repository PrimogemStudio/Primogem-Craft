...
public class TaozhuangceshiProcedure {
	public static void execute(Entity entity, HashMap guistate) {
		...
		if (guistate.get("text:taozhuang_0") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("zizai_tao_zhi")
					...
					+ (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getOrCreateTag().getDouble("zizai_tao_zhi"))));
		if (guistate.get("text:taozhuang_1") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("jianlao_tao_zhi")
					...
					+ (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getOrCreateTag().getDouble("jianlao_tao_zhi"))));
		if (guistate.get("text:taozhuang_2") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("zuisheng_tao_zhi")
					...
					+ (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getOrCreateTag().getDouble("zuisheng_tao_zhi"))));
		if (guistate.get("text:taozhuang_3") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("shengzheng_tao_zhi")
		...
		if (guistate.get("text:taozhuang_4") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("dijing_tao_zhi")
		...
		if (guistate.get("text:taozhuang_5") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("ranyuan_tao_zhi")
					...
					+ (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getOrCreateTag().getDouble("ranyuan_tao_zhi"))));
		if (guistate.get("text:taozhuang_6") instanceof EditBox _tf)
			_tf.setValue((new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getOrCreateTag().getDouble("aixu_tao_zhi")
