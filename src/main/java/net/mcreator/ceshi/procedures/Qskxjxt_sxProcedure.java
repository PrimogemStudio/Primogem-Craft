...
public class Qskxjxt_sxProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (!(entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(PrimogemcraftModMobEffects.QSKXJXTXG.get())) && itemstack.getDamageValue() == 0) {
			itemstack.setDamageValue((int) (itemstack.getMaxDamage() - 1));
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(PrimogemcraftModMobEffects.QSKXJXTXG.get(), 24000, 0, false, false));
