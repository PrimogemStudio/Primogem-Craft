...
public class QiwuchongwangItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7c\u00B7\u751F\u547D\u503C\u8FBE\u5230\u4E0A\u9650\u540E\u9020\u6210\u968F\u673A\u4F24\u5BB3"));
		list.add(Component.literal("\u00A7a\u00B7\u529B\u91CF\uFF08\u221E\uFF09"));
		list.add(Component.literal("\u00A77\u5BC4\u751F\u7ED3\u675F\u65F6\uFF1A"));
		list.add(Component.literal("\u00A7c\u00B7\u9020\u6210\u5927\u91CF\u4F24\u5BB3"));
		list.add(Component.literal("\u00A7"));
		list.add(Component.literal("\u00A77\u9971\u98DF\u5EA6\u5C0F\u4E8E12\u65F6\uFF1A"));
		list.add(Component.literal("\u00A7c\u00B7-80%\u751F\u547D\u503C\u4E0A\u9650\u751F\u547D\u503C"));
		list.add(Component.literal("\u00A7a\u00B7\u8BBE\u7F6E\u9971\u98DF\u5EA6\u81F313"));
	}
