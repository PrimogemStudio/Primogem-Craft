...
public class QwsbmbItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A75\u968F\u7740\u65F6\u95F4\u7684\u63A8\u79FB\uFF0C\u83B7\u5F97\u5947\u7269"));
		list.add(Component.literal("\u00A7e\u00A7l\u5FC5\u5B9A\u4E3A\u8D1F\u9762\u5947\u7269\uFF01"));
		list.add(Component.literal("\u00A76 \u4F46\u6BCF\u6B21\u89E6\u53D1\u65F6\u00A7l35%\u00A7r\u00A76\u6982\u7387\u8FDB\u884C"));
		list.add(Component.literal("\u00A76 \u4E00\u6B21\u00A7e\u00A7l\u95EA\u8000\u7684\u504F\u65B9\u4E09\u516B\u9762\u9AB0\u00A7r\u00A76\u7684"));
		list.add(Component.literal("\u00A76 \u5947\u7269\u6548\u679C"));
	}
