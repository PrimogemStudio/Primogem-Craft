...
public class LiulangzhedejingyanItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.primogemcraft.liulangzhedejingyan.description_0"));
		list.add(Component.translatable("item.primogemcraft.liulangzhedejingyan.description_1"));
		list.add(Component.translatable("item.primogemcraft.liulangzhedejingyan.description_2"));
		list.add(Component.translatable("item.primogemcraft.liulangzhedejingyan.description_3"));
	}
