...
public class Wuqie5Item extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.primogemcraft.wuqie_5.description_0"));
		list.add(Component.translatable("item.primogemcraft.wuqie_5.description_1"));
		list.add(Component.translatable("item.primogemcraft.wuqie_5.description_2"));
	}
}
