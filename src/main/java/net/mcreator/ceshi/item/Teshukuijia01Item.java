...
public abstract class Teshukuijia01Item extends ArmorItem {
	public Teshukuijia01Item(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDurabilityForType(ArmorItem.Type type) {
				return new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 225;
			}
	...
	public static class Helmet extends Teshukuijia01Item {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "primogemcraft:textures/models/armor/teshu01__layer_1.png";
		}
	...
	public static class Leggings extends Teshukuijia01Item {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "primogemcraft:textures/models/armor/teshu01__layer_2.png";
		}
